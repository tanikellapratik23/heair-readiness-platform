...
const prompts: Record<AssessmentRole, string[]> = {
  ...
  it_staff: [
    "How clearly do institutional AI policies define the technical controls, approval requirements, and escalation procedures you are responsible for implementing?", "How effectively are IT Staff involved in establishing role-based access, approved-tool pathways, and technical governance for AI services?", "How adequate are the staffing, budget, platforms, and leadership support available to operate AI services responsibly?", "How consistently does the IT organization monitor AI service performance, usage, incidents, security risks, and remediation outcomes?", "How prepared is the IT organization to secure AI integrations through privacy review, identity controls, encryption, logging, vendor review, and incident response?", "How effectively are data quality, ownership, access permissions, retention, and lineage managed across systems that support AI?", "How prepared is the IT organization to integrate approved AI capabilities with systems such as LMS, SIS, identity, service desk, and data platforms?", "How consistently do technical teams document AI system capabilities, limitations, data flows, decision logs, and escalation paths for affected users?", "How consistently are bias, misuse, accessibility, human oversight, and harmful failure modes evaluated before AI systems are deployed or expanded?", "How effectively does IT Staff gather requirements and feedback from students, faculty, staff, and leadership before and after AI services are introduced?", "How well do IT Staff understand AI capabilities, model limitations, prompt risks, security threats, data exposure, and verification practices?", "How available are opportunities to develop applied expertise in AI architecture, MLOps, data engineering, security, governance, and responsible deployment?"
  ]
};
